...
File: DS203_project_DL_models_final.ipynb

This notebook conatins the DL models tried by us on the GTZAN dataset. 3 sec feature file for simple Dense NN and Mel Spectrogram for CNN based networks were used. InceptionV3 and VGG16 were also tried with the top layer as trainable and non-trainable with the Imagenet weights.
...
File: DS_203_Project_Demo.ipynb 
contains the code which demostrate the classification prediction. Given a audio file as a input it outputs Music Genre using the best achieved model
